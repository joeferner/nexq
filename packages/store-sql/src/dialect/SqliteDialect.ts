import { createId, DuplicateMessageError, getErrorMessage, QueueInfo, SendMessageOptions, Time } from "@nexq/core";
...
export class SqliteDialect extends Dialect<sqlite.Database, SqliteSql> {
  ...
  public override async sendMessage(
    ...
    const deduplicationId = options?.deduplicationId ?? createId();
    try {
